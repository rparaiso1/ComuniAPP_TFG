...
class _ScaffoldWithNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Using child directly — AnimatedSwitcher causes duplicate GlobalKey
    // because ShellRoute's nested Navigator has a persistent GlobalKey.
    // Page-level transitions are handled per-route via _fadeTransition/_sharedAxisZ.
    final body = child;
